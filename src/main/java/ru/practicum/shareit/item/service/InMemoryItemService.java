...
public class InMemoryItemService implements ItemService {
    ...
    public ItemDto addItem(Integer ownerId, ItemDto item) {
        ...
        validateItem(item);
        Item itemToSave = itemMapper.toItem(item, user);
    ...
    private void validateComment(User user, Item item) {
        for (Booking booking : bookingRepository.findAllByBooker_IdAndEndIsBeforeOrderByStart(user.getId(), LocalDateTime.now())) {
